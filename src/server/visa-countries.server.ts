// Canonical list of countries supported by the Visa Requirement RapidAPI provider.
// The endpoint accepts any ISO-3166-1 alpha-2 code, so we ship the full list
// and let the client auto-complete against it.

export type VisaCountry = { code: string; name: string };
