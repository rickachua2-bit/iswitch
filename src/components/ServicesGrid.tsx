...
const SERVICES = [
  ...
  { icon: Hotel, label: "Stays", desc: "Hotels, apartments & villas", to: "/stays", color: "bg-amber-100 text-amber-700" },
  { icon: FileCheck, label: "Visas", desc: "Fast-track visa processing", to: "/visas", color: "bg-emerald-100 text-emerald-700" },
  { icon: Shield, label: "Insurance", desc: "Travel & medical cover", to: "/insurance", color: "bg-rose-100 text-rose-700" },
  { icon: Map, label: "Tours", desc: "Curated experiences", to: "/tours", color: "bg-violet-100 text-violet-700" },
  { icon: Car, label: "Pickups", desc: "Airport transfers & cars", to: "/pickups", color: "bg-orange-100 text-orange-700" },
